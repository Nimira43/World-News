...
const Header = () => {
  return (
    <div className='pl-4 fixed w-[calc(100vw-250px)] top-4 z-50'>
      <div className='w-full rounded h-[70px] flex justify-between items-center p-4 bg-grey-light'>
        <input 
          type='text' 
          placeholder='Search' 
          className='px-3 py-2 rounded-md outline-0 bg-light border border-grey-medium focus:border-grey-dark h-10' 
        />
        <div className='mr-4'>
